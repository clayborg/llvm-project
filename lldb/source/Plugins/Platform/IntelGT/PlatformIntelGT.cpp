...
PlatformIntelGT::PlatformIntelGT() : Platform(/*is_host=*/false) {
  ...
  m_supported_architectures.push_back(ArchSpec("intelgt-intel-levelzero"));
  m_supported_architectures.push_back(ArchSpec("intelgt-intel-levelzero-xe-hp"));
  m_supported_architectures.push_back(
      ArchSpec("intelgt-intel-levelzero-xe-hpg"));
  m_supported_architectures.push_back(
      ArchSpec("intelgt-intel-levelzero-xe-hpc"));
  m_supported_architectures.push_back(ArchSpec("intelgt-intel-levelzero-xe2"));
}
