...
#ifndef LLDB_SOURCE_PLUGINS_STRUCTUREDDATA_NVIDIAGPUMONITOR_STRUCTUREDDATANVIDIAGPUMONITOR_H
#define LLDB_SOURCE_PLUGINS_STRUCTUREDDATA_NVIDIAGPUMONITOR_STRUCTUREDDATANVIDIAGPUMONITOR_H

#include "lldb/Target/StructuredDataPlugin.h"

namespace lldb_private {

class StructuredDataNVIDIAGPUMonitor : public StructuredDataPlugin {
...
public:
  ...
  static llvm::StringRef GetStaticPluginName() { return "nvidia-gpu-monitor"; }
...
private:
  StructuredDataNVIDIAGPUMonitor(const lldb::ProcessWP &process_wp);
...
#endif // LLDB_SOURCE_PLUGINS_STRUCTUREDDATA_NVIDIAGPUMONITOR_STRUCTUREDDATANVIDIAGPUMONITOR_H
