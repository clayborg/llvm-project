...
#ifndef LLDB_TOOLS_LLDB_SERVER_THREADNVGPU_H
#define LLDB_TOOLS_LLDB_SERVER_THREADNVGPU_H
...
class ThreadNVGPU : public NativeThreadProtocol {
public:
  ...
  RegisterContextNVGPU &GetRegisterContext() override { return m_reg_context; }
  ...
  /// \return the process that this thread belongs to.
  const ProcessNVGPU &GetGPU() const;
...
private:
  ...
  RegisterContextNVGPU m_reg_context;
...
using NVGPUThreadRange = GPUThreadRange<ThreadNVGPU>;
} // namespace lldb_private::lldb_server

#endif // #ifndef LLDB_TOOLS_LLDB_SERVER_THREADNVGPU_H
